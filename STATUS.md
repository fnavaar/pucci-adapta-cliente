...
- **F1-T02:** versão `0.0.6` publicada no Skip `RH Pucci`; passos 3, 4 e 5 do teste humano aprovados, passos 6 a 10 ainda pendentes; task não concluída.
...
## Próximo passo
Executar o passo 6 do teste humano da F1-T02 no preview: clicar em `Atualizar trilha` e confirmar que aparecem eventos de auditoria com ator, ação, registro e campos. Não concluir a task nem iniciar a próxima antes da homologação completa.

## Bloqueios ativos
B-IMP-01 (formatos), B-MET-01 (baseline), B-FISC-01 (base INSS), B-STE-01 (Stelanto), passos 6 a 10 do teste humano da F1-T02 e a liberação de dados reais até a homologação — detalhados nas SPECs.
