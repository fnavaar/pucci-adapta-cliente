...
- **F1-T02:** versão `0.0.6` no preview do Skip `RH Pucci`; passos 3, 4, 5, 6 e 7 do teste humano aprovados, passos 8 a 10 ainda pendentes; task não concluída.
...
## Próximo passo
Executar o passo 8 do teste humano da F1-T02 no preview: clicar em `Encerrar` na competência sintética aberta e confirmar status `closed` e t1 preenchido automaticamente. Não concluir a task nem iniciar a próxima antes da homologação completa.

## Bloqueios ativos
B-IMP-01 (formatos), B-MET-01 (baseline), B-FISC-01 (base INSS), B-STE-01 (Stelanto), passos 8 a 10 do teste humano da F1-T02 e a liberação de dados reais até a homologação — detalhados nas SPECs.
